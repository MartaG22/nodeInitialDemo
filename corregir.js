...
// TODO []  Al /ranking/loser i /ranking/winner s'hauria de retornar més d'un usuari si n'hi ha empatats com a guanyadors o perdedors  AL MYSQL.
// TODO []  Bona feina fent les versions de MySQL i Mongo. Seria encara millor si compartissin codi i només tinguessin diferent la configuració de la base de dades i els controladors que calguin (es pot fer un require() condicional al començar en funció de quina configuració s'ha escollit al arrencar). 
    // Així t'estalvies algunes coses com tenir dos cops la col·lecció de Postman, que no cal´
// TODO []  També tens MOLTS logs al server, que haurien d'estar limitats a la versió de desenvolupament. Al npm run mysql no haurien de sortir per consola totes les operacions de les bases de dades, les dades que han arribat amb la request, etc.
// TODO []  S'han de corregir sobretot les coses marcades amb ❗ per acabar de completar l'exercici (està fet però acumula unes quantes males pràctiques importants). Dona-li canya aquestes vacances, que crec que en un parell de tardes ho enllesteixes 💪🏻
