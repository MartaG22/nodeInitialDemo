...
> **Step 3** - Inicialitzar el server en mode desenvolupador.

npm run devMysql -->  Per executar amb la base de dades **MySql**.

npm run devMongo -->  Per executar amb la base de dades **Mongo**.
